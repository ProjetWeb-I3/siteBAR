...
<div class="center">
    ...
    <form method="POST" action="">
        ...
        <div class="txt_field">
            <input type="text" id="username" required name="username" value="<?php if (isset($username)) {
                echo $username;
            } ?>">
            <span></span>
        ...
        <div class="txt_field">
            <input type="text" id="familyname" required name="familyname" value="<?php if (isset($familyname)) {
                echo $familyname;
            } ?>">
            <span></span>
        ...
        <div class="txt_field">
            <input type="text" id="firstname" required name="firstname" value="<?php if (isset($firstname)) {
                echo $firstname;
            } ?>">
            <span></span>
        ...
        <div class="txt_field">
            <input type="email" id="mail" required name="mail" value="<?php if (isset($mail)) {
                echo $mail;
            } ?>">
            <span></span>
        ...
        <div class="txt_field">
            <input type="email" id="mail2" required name="mail2" value="<?php if (isset($mail2)) {
                echo $mail2;
            } ?>">
            <span></span>
        ...
        <div class="signup_link">
            Déjà membre ?<a href="<?php echo $GLOBALS['URL_CSS'] . "/Views/Pages/Authentication/login.php" ?>">
                Connexion</a><a href="<?php echo $GLOBALS['URL_CSS'] . "/index.php"; ?>"> / Retour</a><br\>
            <br/>
            <br/>
            <?php
