  	 ...
  	 <div class="container2">
  	 	<div class="row">
  	 		...
  	 		<div class="footer-col">
  	 			<h4>Contacts</h4>
  	 			<ul>
  	 				<li><a href="#">contact@nettysol.com</a></li>
  	 				<li><a href="#">11 voie Héméra, 31190 Auterive</a></li>
  	 		...
  	 		<div class="footer-col">
  	 			...
  	 			<div class="social-links">
  	 				<a href="https://fr-fr.facebook.com/pages/category/Cleaning-Service/SAS-Nettysol-1692848397395910/"><i class="fab fa-facebook-f"></i></a>
...
<!-- le copyright du site -->
	<div class="copyright">
		<p>Copyright 2020 Nettysol. Tous droits réservés. Par CG</p>
